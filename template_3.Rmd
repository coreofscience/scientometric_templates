...
wos_scopus_tos <- 
  tosr::tosr_load("family_schol_548.bib", 
                  "family_school_320.txt")

wos <- 
  bibliometrix::convert2df("family_school_320.txt")  # create dataframe from wos file

scopus <- 
  bibliometrix::convert2df("family_schol_548.bib", # Create dataframe from scopus file
                           dbsource = "scopus", 
                           format = "bibtex")
```
...
# Wos
wx = r.wos_anual_production['PY']
wx1 = wx - np.array(0.3) # Here we moved wos bars
wy = r.wos_anual_production['n']

# Scopus
sx = r.scopus_anual_production['PY']
sx1 = sx + np.array(0.3) # here we moved scopus bars 
sy = r.scopus_anual_production['n']
