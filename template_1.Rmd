...
```{r}
wos_scopus_tos <- 
  tosr::tosr_load("scopus (1).bib", "savedrecs (1).txt")

tree_of_science <- 
  tosr::tosR("scopus (1).bib", "savedrecs (1).txt")

wos <- 
  bibliometrix::convert2df("savedrecs (1).txt")  # create dataframe from wos file

scopus <- 
  bibliometrix::convert2df("scopus (1).bib", # Create dataframe from scopus file
                           dbsource = "scopus", 
                           format = "bibtex")
```
