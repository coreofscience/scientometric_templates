...
wos_scopus_citation_network_clusters <- 
  wos_scopus_citation_network |> 
  delete.vertices(which(V(wos_scopus_citation_network)$subfield != 14 & # filter clusters 
                          V(wos_scopus_citation_network)$subfield != 4 &
                          V(wos_scopus_citation_network)$subfield != 9  &
                          V(wos_scopus_citation_network)$subfield != 5))
...
cluster_3 <- 
  wos_scopus_citation_network |> 
  delete.vertices(which(V(wos_scopus_citation_network)$subfield != 9))
...
cluster_4 <- 
  wos_scopus_citation_network |> 
  delete.vertices(which(V(wos_scopus_citation_network)$subfield != 5))
