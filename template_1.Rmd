...
library(lubridate)
library(igraph)
library(ggraph) # Pretty network visualization
library(tidytext)
library(wordcloud)
library(rebus)
...
```{r}
wos_scopus_tos <- 
  tosr::tosr_load("co_citation_title_222.txt",  # Create data from searches 
                  "co_citation_title_395.bib")

tree_of_science <- 
  tosr::tosR("co_citation_title_222.txt",  # Create data from searches 
                  "co_citation_title_395.bib")

wos <- 
  bibliometrix::convert2df("co_citation_title_222.txt") # create dataframe from wos file

scopus <- 
  bibliometrix::convert2df("co_citation_title_395.bib", # Create dataframe from scopus file
                           dbsource = "scopus", 
                           format = "bibtex")
